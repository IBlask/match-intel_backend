...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> emailVerificationResend(@RequestParam String email) {
    ...
    public ResponseEntity<Void> changeEmailBySessionToken(@RequestParam String sessionToken, @RequestParam String newEmail) {
